...
export default function CategoryList() {
  ...
  // CSV Export mapping
  const exportRow = (item: SubCategories) => ({
    Name: item.name,
  ...
  const searchSubCategories = (subCategory: any, searchTerm: string) => {
    const term = searchTerm.toLowerCase();
    return subCategory.name.toLowerCase().includes(term);
  };
  ...
  return (
    <>
      <PageMeta title="Sub Category List" description="Subcategory listing and management." />
      <PageBreadcrumb pageTitle="Sub Category" />
      <ComponentCard title="Sub Category List">
        <AdvancedTable
          addButton={{ label: "Add Sub Category", slug: "/sub-categories/detail" }}
          data={categories}
          columns={columns}
          loading={loading}
          ...
          searchFunction={searchSubCategories}
          type="subcategory"
          exportRow={exportRow}
